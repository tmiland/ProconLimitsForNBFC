...
// Messages
String msg = "WARNING: You will be AUTO-KICKED if you use EXPLOSIVES!";
String yellMsg = @"WARNING: You will be AUTO-KICKED if you use EXPLOSIVES!";
String msg1 = "WARNING: You will be AUTO-KICKED if you use EXPLOSIVES!";
