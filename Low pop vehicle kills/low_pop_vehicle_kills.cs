...
int warningCount = 3; // you can change this number
int adminKillCount = 4; // you can change this number
int kickCount = 5; // you can change this number
...
bool isVehicle = (kill.Category == "VehicleLight" || kill.Category == "VehicleHeavy" || kill.Category == "VehicleAir" || kill.Category == "VehicleWater");
...
if (count >= kickCount) {
	...
	plugin.SendGlobalMessage(kickMessage);
...
int noticeCount = 4; // you can change this number
...
String prefix = "LowPopSpawnNotice_";
