...
List<String> tips = new List<String>();
	...
	tips.Add("After firing the SRAW, quickly let go of ADS to prevent it from aiming off target if you happen to die!");
 	tips.Add("Are you the last member of your squad who is still alive? Make sure you are a safe spawn point for your squad!");
	tips.Add("Be careful with playing solo. You will usually do better if you stay close to your team or squad mates!");
	tips.Add("Extra points are another benefit of sticking with your squad. You will get extra points for healing, reviving, and supplying your squad mates!");
	...
	tips.Add("If you are driving a car or a motorcycle en route to the target, ditch your ride a while before you get there so that the engine sound does not give you away.");
	tips.Add("Do not pick the obvious routes to your target. Use a detour, just to surprise the welcome committee.");
	tips.Add("Do not run straight to the flag immediately. Try getting an overview of the area surrounding the target first. Take out any bad guys before moving towards the target.");
	tips.Add("No matter what the cover is, try playing so that you always got cover between you and your opponents. Plan your movements.");
	...
	tips.Add("Avoid open areas. Letting your character run around in the middle of street or in the wide open, you will quickly become the opposing teams favorite.");
	...
	tips.Add("Make sure the character you just took out does not have any friends lurking about, before you reload.");
	tips.Add("When you walk more than you run, you will pick up on more of whats going on around your character.");
	tips.Add("The time it takes from you stopping moving your character until it can start firing its weapon is a little bit shorter when you are walking instead of running.");
